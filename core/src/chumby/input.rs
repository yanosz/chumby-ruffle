...
//! stdin and, optionally, a FIFO (`--chumby-control PATH`, hook H8) that any
//! shell can write to: `echo bend > PATH`. One command per line:
//!
//! ```text
...
/// Spawn the reader threads. Called once at startup (desktop main, hook H8).
